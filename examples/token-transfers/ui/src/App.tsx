...
import { TokenTransfersPanel } from "@/components/token-transfers-panel";
        ...
        <div className="min-h-screen bg-background text-foreground">
          <header className="border-b">
            <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-between gap-3 px-4 py-3">
              <h1 className="text-lg font-semibold">Midnight Token Transfers</h1>
...
function Main() {
  ...
  return (
    <>
      ...
      {locked ? <PassphraseCard /> : <TokenTransfersPanel />}
    </>
  );
}
