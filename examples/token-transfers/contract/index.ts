...
// resolve against contract/managed/token-transfers, which is generated by `yarn compile`
// (gitignored). Write contract/token-transfers.compact first, then compile.
