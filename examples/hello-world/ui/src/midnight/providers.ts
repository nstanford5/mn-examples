...
//   privateStateProvider  LevelDB                       in-memory (the contract has no witnesses)
...
export async function createProviders(
  ...
  // Fetches keys/storeMessage.{prover,verifier} and zkir/storeMessage.bzkir
  // from the page's own origin. scripts/copy-zk.mjs puts them there.
