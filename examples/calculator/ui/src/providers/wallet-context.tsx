...
const AUTOCONNECT_KEY = "calculator-ui:wallet-autoconnect";
const NETWORK_KEY = "calculator-ui:network-id";
const WALLET_KEY = "calculator-ui:wallet";

/**
 * Network ids a Midnight wallet recognizes. `undeployed` is the local devnet
 * from examples/calculator/compose.yml.
 */
