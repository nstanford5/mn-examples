...
const AUTOCONNECT_KEY = "private-party-ui:wallet-autoconnect";
const NETWORK_KEY = "private-party-ui:network-id";
const WALLET_KEY = "private-party-ui:wallet";

/**
 * Network ids a Midnight wallet recognizes. `undeployed` is the local devnet
 * from examples/private-party/compose.yml.
 */
